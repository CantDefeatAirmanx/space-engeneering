...
func (_mock *MockPartService) GetPart(ctx context.Context, uuid string) (*model_part.Part, error) {
...
func (_c *MockPartService_GetPart_Call) Return(part *model_part.Part, err error) *MockPartService_GetPart_Call {
	_c.Call.Return(part, err)
	return _c
}

func (_c *MockPartService_GetPart_Call) RunAndReturn(run func(ctx context.Context, uuid string) (*model_part.Part, error)) *MockPartService_GetPart_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockPartService_GetParts_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetParts'
type MockPartService_GetParts_Call struct {
	*mock.Call
}
...
func (_c *MockPartService_GetParts_Call) Return(parts []*model_part.Part, err error) *MockPartService_GetParts_Call {
